<template>
	<view class="otherFct">
		...
		<view class="loginIcon">
			<view class="otherLogin" @click="loginWx"><image class="wxBtn" src="/static/image/login/wechat.png" mode="aspectFit"></image></view>
			<view class="otherLogin" @click="loginQQ"><image class="qqBtn" src="/static/image/login/qq.png" mode="aspectFit"></image></view>
		</view>
		<view class="tipBox">
			登录即代表同意
