<template>
	<view>
		<navBar :back="false" type="transparent" fontColor="#FFF"><view slot="right" class="navTitle" @click="navToPassLogin">密码登录</view></navBar>
		<image class="bgImg" :src="bgSrc" mode="aspectFill"></image>
		<!-- 标题 -->
		<view class="titleBox">
			手机号登录
			<view class="titleInfo">榴莲出国-记录你的澳洲征程</view>
		</view>
		<!-- 主要功能区 -->
		<phoneInput v-model="phoneNumber" @changeCode="codeFct"></phoneInput>

		<login-btn @click="navToCode" name="获取验证码"></login-btn>

		<view class="infoBox">未注册手机验证后自动登录</view>
		<!-- 下方附属功能 -->
		<otherFct></otherFct>
	</view>
</template>
