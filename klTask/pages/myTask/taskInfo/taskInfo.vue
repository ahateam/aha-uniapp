	...
	<view id="page">
		<view v-if="pageStatus != 'onload'">
			...
			<view class="top-user-box flex-box">
				...
				<image :src="constData.oss + task.upUser.userHead" mode="aspectFill"></image>
			</view>
		...
		<uni-popup animation type="bottom" :show="popupShow" @change="colsePopup">
			<view class="bottom-btn-box">
				<view class="bottom-btn">编辑报价</view>
				<view class="bottom-btn" style="border: none;" @tap="revokeBtn">撤销报价</view>
			</view>
		</uni-popup>
