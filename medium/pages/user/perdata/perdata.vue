		...
		methods: {
			...
			saveData() {
				if (this.userInfo.userName == '') {
					...
					if (this.userInfo.FIER) {
						cnt.fierNumber = this.userInfo.FIER
					}

					if (this.userInfo.MARN) {
						cnt.marnNumber = this.userInfo.MARN
					}

					if (this.userInfo.NAATI) {
						cnt.naatiNumber = this.userInfo.NAATI
					}
