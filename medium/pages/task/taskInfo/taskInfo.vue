	...
	<view style="padding-bottom: 102rpx;">
		<view class="top-box">
			...
			<view class="top-content">
				<image class="back-icon" src="/static/image/icon/icon_back_w.png" mode="aspectFit"></image>
		...
		<view class="content-box">
			...
			<view class="block-box">
				...
				<view class="auto-box-gray space-box">
					...
					<view class="right-info bottom-font">{{task.taskStatus}}</view>
				</view>
				<view class="auto-box-gray space-box">
				...
				<view class="auto-box-gray" style="border: none;">
