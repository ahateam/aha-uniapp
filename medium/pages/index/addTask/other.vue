<template>
	<view>
		<nav-bar :back="false">
			...
			<view class="view-title">其他任务</view>
		</nav-bar>
		<view style="margin-top: 10rpx;"></view>

		<data-input :inputHidden="aptitudesStatus" v-model="taskType" hiddenIcon disabled value="其他" title="任务分类"></data-input>
