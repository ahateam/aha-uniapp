	...
	<view>
		<view class="box">
			...
			<view class="content-box">
				<view class="title-box">输入验证码</view>
				<view class="title-tell">
					<view class="code-text">已发送4位验证码至</view>
					<view class="tell-text">+{{ tell }}</view>
				</view>
				<view class="code-box"><valid-code :maxlength="4" :isPwd="false" @finish="finish"></valid-code></view>
				<view class="code-btn" @click="submitBtn">确定</view>
				<view class="send-btn-num" v-if="num > 0">重发验证码({{ num }}s)</view>

				<view class="send-btn" v-else @click="sendBtn">重发验证码</view>
			</view>
		</view>
	</view>
</template>
