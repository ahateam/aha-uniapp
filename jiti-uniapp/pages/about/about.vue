<template>
	<view>
		<view class="user-title">
			<view class="updata-icon">
				<image src="../../static/sz.png" @click="updataPwd"></image>
			</view>
			<image src="../../static/user.png"></image>
			<view class="name-text">{{name}}</view>
		</view>
		<view class="maincon user-info">
			<view class="org-item">
				<view class="org-name">我的职务：</view>
				<view class="org-res">{{userPost}}</view>
			</view>
			<view class="org-item">
				<view class="org-name">身份证号：</view>
				<view class="org-res">{{idNumber}}</view>
			</view>
			<view class="org-item">
				<view class="org-name">我的股份：</view>
				<view class="org-res">{{shareAmount}}</view>
			</view>
			<view class="org-item">
...
<script>
	export default {
		...
		onShow() {
			...
			this.getSysORGUserRoles(orgRoles)
