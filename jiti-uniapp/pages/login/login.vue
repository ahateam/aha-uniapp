				...
				<view class="form_box">
					<view class="input_box">
						<view class="input-text">
							<input type="text" class="text" placeholder="手机号/身份证" placeholder-class="place-holder" v-model="userName">
						</view>
					</view>

					<view class="input_box">
						<view class="input-text">
							<input type="text" password="true" class="text" placeholder="请输入密码" placeholder-class="place-holder" style="color: #666;"
							 v-model="pwd">
						</view>
					</view>
...
<style scoped lang="scss">
	...
	.text {
		border-bottom: #ced9ff solid 3rpx;
		font-size: 32rpx;
	}
